...
@Component({
  selector: 'app-tax-abstractpurchase',
  templateUrl: './tax-abstractpurchase.component.html',
  styleUrls: ['./tax-abstractpurchase.component.css']
})
export class TaxAbstractPurchaseComponent implements OnInit {
  canShowMenu: boolean;
  data: any;
  roleId: any;
  regions: any;
  ...
  ngOnInit() {
    ...
    this.TaxReportCols = this.tableConstants.TaxReportPurchaseColumns;
  }
